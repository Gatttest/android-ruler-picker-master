...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragmentsList.add(testFragment.newInstance("Events fragment test"));
        ...
        fragmentsList.add(testFragment.newInstance("Profile fragment test"));
        fragmentsList.add(SampleFragment.newInstance("Map fragment"));
        fragmentsList.add(SampleFragment.newInstance("Visualize fragment"));
        fragmentsList.add(testFragment.newInstance("Human library fragment test"));
